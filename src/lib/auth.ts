...
export const ROLE_ACCESS: Record<string, string[]> = {
  ADMIN: [
    ...
    "costs", "inventory", "purchases", "suppliers", "debts", "employees", "salaries", "settings",
  ],
  MANAGER: ["dashboard", "orders", "production", "invoices", "customers", "payments", "employees", "suppliers"],
